                    ...
                    <div class="card-body" style="background-color:aliceblue">
                        <form id="signupForm" method="POST" class="form-horizontal" action="" onsubmit="return confirmFix();">
                            ...
                            <div class=" mb-3">
                                ...
                                <input type="file" id="" name="coverImg" value="<?= htmlspecialchars($ketqua1['coverImg']) ?>">
                            </div>

                            <div class="">
                                <div class="d-grid">
                                    <input type="submit" class="btn btn-outline-info" name="fix_bookname" value="Sửa" />
                                </div>
                            </div>
                        </form>
                    </div>
